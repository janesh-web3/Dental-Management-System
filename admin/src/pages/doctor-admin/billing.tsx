...
import { 
  Loader2, Search, Download, FileText, DollarSign, Calendar, User
} from "lucide-react";
...
const Billing: React.FC<BillingProps> = ({ doctorId }) => {
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>
                View invoices for your patients
              </CardDescription>
            </div>
          </div>
        </CardHeader>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="font-medium">{selectedInvoice.patient.personalDetails.name}</p>
                  </div>
                  <div>
                    <div className="flex items-center gap-1 text-sm text-muted-foreground">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="space-y-2 text-right">
                    <div>
                      ...
                      <p className="font-medium">${selectedInvoice.subtotal.toFixed(2)}</p>
                    </div>
                    
                    {selectedInvoice.tax > 0 && (
                      <div>
                        <span className="text-sm text-muted-foreground">Tax:</span>
                        <p className="font-medium">${selectedInvoice.tax.toFixed(2)}</p>
                      </div>
                    )}
                    ...
                    {selectedInvoice.discount > 0 && (
                      <div>
                        ...
                        <p className="font-medium">-${selectedInvoice.discount.toFixed(2)}</p>
                      </div>
                    )}
                    ...
                    <div>
                      ...
                      <p className="font-medium">${selectedInvoice.amountPaid.toFixed(2)}</p>
                    </div>
                    
                    <div>
                      <span className="text-sm text-muted-foreground">Balance:</span>
                      <p className="font-medium">${selectedInvoice.balance.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
