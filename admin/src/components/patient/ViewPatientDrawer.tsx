  ...
  const exportPatientPDF = () => {
    try {
      ...
      const personalData = [
        ...
        ["Age/Gender", `${patient.personalDetails.age || "-"} / ${patient.personalDetails.gender || "-"}`],
        ...
        ["Check-up Date", formatSafeDate(patient.personalDetails.checkUpDate || "")]
      ];
      ...
      if (patient.medicalDetails && patient.medicalDetails.length > 0) {
        ...
        if (medicalHistory.noMedicalIssues) {
          ...
          if (medicalHistory.diabetes) medicalConditions.push(["Diabetes", "Yes"]);
          if (medicalHistory.thyroid) medicalConditions.push(["Thyroid", "Yes"]);
          if (medicalHistory.bleedingDisorder) medicalConditions.push(["Bleeding Disorder", "Yes"]);
          if (medicalHistory.pregnancy) medicalConditions.push(["Pregnancy", "Yes"]);
          if (medicalHistory.asthma) medicalConditions.push(["Asthma", "Yes"]);
          if (medicalHistory.bloodPressure) medicalConditions.push(["Blood Pressure", medicalHistory.bloodPressure]);
          if (medicalHistory.allergies) medicalConditions.push(["Allergies", medicalHistory.allergies]);
          if (medicalHistory.otherConditions) medicalConditions.push(["Other Conditions", medicalHistory.otherConditions]);
        }
        ...
        if (medicalDetails.treatmentPlanning && medicalDetails.treatmentPlanning.length > 0) {
          ...
          medicalDetails.treatmentPlanning.forEach((plan, index) => {
            ...
            doc.text(`Plan ${index + 1}: ${plan.treatmentDetails || "Treatment Plan"}`, 14, currentY);
            doc.setTextColor(0);
            currentY += 8;
              ...
              <TabsContent value="overview" className="space-y-6 pb-6">
                ...
                <Card className="border-none shadow-sm bg-card">
                  ...
                  <CardContent className="grid md:grid-cols-2 gap-4">
                    {localPatient.medicalDetails[0]?.medicalHistory?.noMedicalIssues ? (
              ...
              <TabsContent value="medical" className="space-y-6 pb-6">
                {localPatient.medicalDetails.length === 0 ? (
                  ...
                  localPatient.medicalDetails.map((record) => (
                    <Card
                      key={record._id}
                      className="border border-primary/10 shadow-sm bg-card overflow-hidden"
                    >
                      ...
                      <CardContent className="p-0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border-b">
                          ...
                          <div>
                            ...
                            <div className="bg-muted/30 p-3 rounded-md text-sm">
                              {(record.investigation?.blood || record.investigation?.xray) ? 
                                "See details below" : 
                                ...
                                >
                                  ...
                                  <div className="p-4">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4 bg-muted/10 p-3 rounded-md">
                                      ...
                                      {treatment.treatedByDoctor && (
                                        <div>
                                          ...
                                          <p className="font-medium text-sm">
                                            {treatment.treatedByDoctor.name}
                                          </p>
                                        </div>
                                      )}
                                    ...
                                    {treatment.selectedTeethDetails &&
                                      treatment.selectedTeethDetails.length >
                                        0 && (
                                        <div className="mb-4">
                                          ...
                                          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                            {treatment.selectedTeethDetails.map(
                                              (tooth) => (
                                                <div
                                                  key={tooth.number}
                                                  className="bg-card border rounded-md hover:border-primary/50 transition-colors p-2"
                                                >
                                    ...
                                    <div>
                                      ...
                                      <div className="grid grid-cols-3 gap-2 bg-card p-3 rounded-md border">
