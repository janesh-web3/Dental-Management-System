      ...
      <div className="container flex items-center h-14 max-lg:px-5">
        <a className="flex-1 cursor-pointer lg:hidden z-2">
          <img
            ...
            height={50}
            alt="logo"
            className="object-contain bg-transparent mix-blend-color-burn"
          />
        </a>
              ...
              <ul className="flex max-lg:block max-lg:px-12">
                ...
                <li className="nav-logo">
                  <LinkScroll
                    ...
                    smooth
                    className={clsx(
                      "max-lg:hidden transition-transform duration-500 cursor-pointer flex items-center"
                    )}
                  >
                    <img
                      src="/images/t.png"
                    ...
                    />
                    <h1 className="text-blue-500 font-bold text-3xl ml-[-20px]">
                      DEN<span className="text-yellow-500">TAL</span>
                    </h1>
                  </LinkScroll>
                </li>
