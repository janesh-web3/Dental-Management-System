    ...
    <section>
      <Element name="pricing">
        <div className="container">
          ...
          {/*  pricing section*/}
          <div className="relative flex items-stretch justify-center -mt-12 scroll-hide z-2 max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, index) => (
              <div
                key={plan.id}
                className={clsx(
                  "pricing-plan_first pricing-plan_last relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(50%-2px)] flex flex-col",
                  index === 1 && "xl:ml-4"
                )}
              >
                {index === 1 && (
